...
#SBATCH -e anvio_maxbin_euk_2020.txt
#SBATCH -J crabs_maxbin
...
anvi-cluster-contigs -p Crab_merged_kaiju_1000bp_EUK/PROFILE.db -c Crab_Euk.db  -C MAXBIN --driver maxbin2 -T 48 --just-do-it
